    ...
    <div class="main">
        ...
        <table class="table table-bordered">        
            ...
            <form action="upload.php" method="POST" enctype = "multipart/form-data">
                <?php
                $sql = "SELECT * FROM spp where student = 'MIGEL AULIA' and pstatus = 'BELUM DIBAYAR'";
                ...
                while ($payment = mysqli_fetch_array($query)) 
                {
                    ...
                    // echo "<td><img src='images/".$payment['pbukti']."' width='10' height='10'></td>"; 
                    echo '<td><input type="file" name="pbukti"/></td>';
                    echo '<td><input type="submit" value="Tambah" name="tambah" /></td>';
                }
                ?>
               <!-- <td>
